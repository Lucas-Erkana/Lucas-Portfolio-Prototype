...
# 📖 Lucas Erkana Portfolio Prototype <a name="about-project"></a>
...
- On the terminal run this command git clone https://github.com/Lucash2022/Lucas-Portfolio-Prototype.git
...
-Add videos or the different Lesson

-Add more content

-Add quizzes that users can take and get results
...
Feel free to check the [issues page](https://github.com/Lucash2022/Lucas-Portfolio-Prototype/issues).
